...
const Harvest: React.FC = () => {
	...
	return (
		<Box>
			<Card>
				<CardContent style={{backgroundColor:"#eee", color:"#2c2560 !important"}}>
					<StyledCardContentInner>
						<StyledCardHeader>
							<CardIcon>
								<TokenSymbol symbol="TOMP" />
							</CardIcon>
							<Value value={getDisplayBalance(earnings)} />
							<Label text={`≈ $${earnedInDollars}`} color="#2c2560!important" />
							<Label text="TOMB Earned" color="#2c2560!important" />
						</StyledCardHeader>
						<StyledCardActions>
							<Button
								onClick={onReward}
