...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      TOMB: ['0xAD522217E64Ec347601015797Dd39050A2a69694', 0],
      MIM: ['0x39523112753956d19A3d6a30E758bd9FF7a8F3C0', 9],
      'USDT-FTM-LP': ['0xE7e3461C2C03c18301F66Abc9dA1F385f45047bA', 18],
      'TOMP-FTM-LP': ['0x13Fe199F19c8F719652985488F150762A5E9c3A8', 18],
      'TSHARE-FTM-LP': ['0x20bc90bB41228cb9ab412036F80CE4Ef0cAf1BD5', 18],
      'TOMP-TSHARE-LP': ['0xd9B5f00d183df52D717046521152303129F088DD', 18],
    },
  ...
  production: {
    ...
    externalTokens: {
      ...
      'TOMP-FTM-LP': ['0xbdc7dfb7b88183e87f003ca6b5a2f81202343478', 18], // 
      'TSHARE-FTM-LP': ['0x6398ACBBAB2561553a9e458Ab67dCFbD58944e52', 18],
      'TOMP-TSHARE-LP': ['0xd9B5f00d183df52D717046521152303129F088DD', 18],
    },
    baseLaunchDate: new Date('2021-06-02 13:00:00Z'),
    bondLaunchesAt: new Date('2020-12-03T15:00:00Z'),
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombFtmLPTombRewardPool: {
    name: 'Earn TOMP by TOMP-WFTM',
    poolId: 0,
    sectionInUI: 1,
    contract: 'TombFtmLpTombRewardPool',
    depositTokenName: 'TOMP-FTM-LP',
    earnTokenName: 'TOMP',
    multiplier: "1000x",
    finished: false,
    sort: 5,
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Earn TSHARE by TOMP-WFTM LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn TSHARE by TSHARE-WFTM LP',
    poolId: 1,
    sectionInUI: 2,
  ...
  TombTsharePTShareRewardPool: {
    name: 'Earn TSHARE by TOMP-TSHARE LP',
    poolId: 2,
    sectionInUI: 2,
    contract: 'TombTshareLPTShareRewardPool',
    depositTokenName: 'TOMP-TSHARE-LP',
    earnTokenName: 'TSHARE',
    multiplier: "550x",
    finished: false,
    sort: 8,
  ...
  // TshareDividends: {
  //   name: 'Earn USDC dividends by staking TSHARES',
  //   poolId: 0,
  //   sectionInUI: 3,
  //   contract: 'TombTshareLPTShareRewardPool',
